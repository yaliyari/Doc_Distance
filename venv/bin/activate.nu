...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SJ482KA\PycharmProjects\Doc_Distance\venv'
    let bin = 'bin'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SJ482KA\PycharmProjects\Doc_Distance\venv\bin\deactivate.nu'
